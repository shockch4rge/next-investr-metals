...
export type TradingTimeframe = "1m" | "1w" | "1y" | "6m";
...
export const TradingPreferencesProvider: React.FC<PropsWithChildren> = ({ children }) => {
    ...
    return <TradingPreferencesContext.Provider 
        value={{ currency, setCurrency, timeframe, setTimeframe, setMetalType, metalType }}
    >
        {children}
